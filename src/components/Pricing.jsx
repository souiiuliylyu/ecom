    ...
    <section id="pricing" className="section" style={{ padding: '6rem 0' }}>
      <div className="container">
        <div className="text-center" style={{ marginBottom: '3rem' }}>
          <h2 className="h2">Replace a team. Pay for a tool.</h2>
          <p className="lead">One AI agent that runs your entire e-commerce operation 24/7.</p>
        </div>
        ...
        <div className="pricing-wrapper card">
          ...
          <div className="pricing-row" style={{ backgroundColor: '#f8fafc' }}>
            <div style={{ padding: '2rem' }}>
              ...
              <div className="strike-through" style={{ fontSize: '2rem', fontWeight: 800 }}>$13,000/mo</div>
